...
sap.ui.define([
    ...
    "zmmo071101/control/BarcodeScannerContainer"], 
    ...
    b({
        url: sap.ui.require.toUrl("zmmo071101/css/barcodeStyle.css")
    });
    var d = {}, C, z, Z, s = new J({
        available: false
    }), S = null, o = {}, f = "", g = {
    ...
    function u() {
        Z = sap.ui.requireSync("zmmo071101/lib/ZXing");
        if (Z) {
            const hints = new Map();
