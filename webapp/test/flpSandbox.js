		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Post GR Order (Fence)",
									"targetURL": "#PostGROrder(Fence)-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PostGROrder(Fence)-display": {
								"semanticObject": "PostGROrder(Fence)",
								"action": "display",
								"description": "Post Goods Receipt Order (Fence)",
								"title": "Post GR Order (Fence)",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmo071101",
									"url": sap.ui.require.toUrl("zmmo071101")
								}
							}
						}
					}
